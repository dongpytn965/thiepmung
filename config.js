const nameGirl = 'N.H.Hậu';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng Hậu 20/10';
const contentCard = 'Chúc Cô Hậu 20/10 vui vẻ, Chúc em luôn luôn xinh đẹp, hạnh phúc và thành công trong cuộc sống';
